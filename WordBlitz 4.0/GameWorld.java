...
public class GameWorld extends World {
    ...
    public GameWorld(float speed) {
        ...
        slideIn.setSlidingWord(tmp, 296, 114, 115);
        
        addObject(correctWordOverlay, 525, 468);
        addObject(wrongWordOverlay, 525, 468);
    ...
    public void checkWords(boolean enter, String key) {
        ...
        if(enter){
            ...
            slideOut.setSlidingWord(currentWord, 296, 390, 500);
            ...
            slideIn.setSlidingWord(newWord, 296, 0, 115);
